...
class Board {
  constructor(container) {
    ...
    // temporary
    // empty it out
    setTimeout(() => __WEBPACK_IMPORTED_MODULE_0__jewel__["a" /* default */].retrieveMovedJewels(), 3000);
  ...
  handleSet(jewels) {
    ...
    this.remove(toRemove)
      ...
      .then(() => this.handleSet(__WEBPACK_IMPORTED_MODULE_0__jewel__["a" /* default */].retrieveMovedJewels()));
    ...
    return new Promise(resolve => {
      setTimeout(() => {
        posRow.forEach((pos) => {
          ...
          this.cols[pos.x][0] = __WEBPACK_IMPORTED_MODULE_0__jewel__["a" /* default */].random(new __WEBPACK_IMPORTED_MODULE_2__pos__["a" /* default */](pos.x, 0), this.container).place(0)
        })
