...
class Board {
  ...
  start() {
    this.frozen = false;
    this.handleSet(__WEBPACK_IMPORTED_MODULE_1__jewel__["a" /* default */].retrieveMovedJewels());
  }
  ...
  updateInCols(posRow) {
    posRow.forEach((pos) => {
      ...
      this.cols[pos.x][0] = __WEBPACK_IMPORTED_MODULE_1__jewel__["a" /* default */].random(new __WEBPACK_IMPORTED_MODULE_3__pos__["a" /* default */](pos.x, 0), this.game.grid, this.level).place(700) // wait for swap and remove animation
    })
  }
  ...
  clear() {
    __WEBPACK_IMPORTED_MODULE_1__jewel__["a" /* default */].retrieveMovedJewels(); // clear out last level's jewels
    setTimeout(() => {
      const allJewels = [];
      for (let y = 7; y >= 0; y--) {
        for (let x = 0; x < 8; x++) {
