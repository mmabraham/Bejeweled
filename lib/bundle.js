...
class Board {
  constructor(container) {
    ...
    setTimeout(() => this.handleSet(__WEBPACK_IMPORTED_MODULE_0__jewel__["a" /* default */].retrieveMovedJewels()), 1200);
  ...
  handleSet(jewels) {
    ...
    this.updatePoints(toRemove.length)
    setTimeout(() => { this.handleSet(__WEBPACK_IMPORTED_MODULE_0__jewel__["a" /* default */].retrieveMovedJewels()) }, 1000);
