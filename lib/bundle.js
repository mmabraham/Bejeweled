...
class Board {
  constructor(game, level) {
    ...
    this.frozen = false;
    // game.grid.addEventListener("touchmove", this.handleSelect.bind(this))
  }
  ...
  selectJewel(pos) {
    ...
    // if (this.selected && this.selected.pos.x === newJewel.pos.x && this.selected.pos.y === newJewel.pos.y) {debugger; null}
