...
class Game {
  ...
  incrementLevel() {
    this.board.frozen = true;
    __WEBPACK_IMPORTED_MODULE_2__jewel__["a" /* default */].retrieveMovedJewels(); // clear out last level's jewels
    this.board.clear();
    this.level += 1;
    this.levels.innerHTML = `Level ${this.level - 4}`
    setTimeout(() => {
...
class Board {
  constructor(game, level) {
    this.game = game;
    this.cols = {};
    this.progress = new __WEBPACK_IMPORTED_MODULE_0__progress__["a" /* default */](level * 70000);
    this.level = level;
