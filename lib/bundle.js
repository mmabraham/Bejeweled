...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__jewel__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__null_jewel__ = __webpack_require__(6);
...
class Board {
  ...
  remove(row) {
    setTimeout(() => {
      row.forEach(jewel => {
        console.log(`removing jewel ${jewel} at ${jewel.pos.x}, ${jewel.pos.y}`)
        this.replace(jewel.pos);
        jewel.remove()
        this.cols[jewel.pos.x][jewel.pos.y] = new __WEBPACK_IMPORTED_MODULE_1__null_jewel__["a" /* default */](jewel.pos)
      });
    }, 500)
  }
  ...
  replace(pos) {
    ...
    // for (let key in col) {
      // if (key < y) {
        // setTimeout(() => {
          console.log(`we are in replace ${pos.x}, ${pos.y}`)

          col[pos.y - 1].moveDown();
          this.updateCols(col[pos.y - 1]);
        // }, 500)
      // }
    // }
  ...
  // for debugging
  verify() {
    for (let x in this.cols) {
      for (let y in this.cols[x]) {
        if (!this.cols[x][y].pos.x === x && this.cols[x][y].pos.y === y ) {
          debugger
          console.ERROR('=======================   ERROR   ==================================');
        }
      }
