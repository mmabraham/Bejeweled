...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pos__ = __webpack_require__(5);
...
class Board {
  ...
  populate() {
    for (let x = 0; x < 8; x++) {
      this.cols[x] = {};
      for (let y = 0; y < 8; y++) {
        this.cols[x][y] = __WEBPACK_IMPORTED_MODULE_0__jewel__["a" /* default */].random(new __WEBPACK_IMPORTED_MODULE_1__pos__["a" /* default */](x, y), this.container).place()
      }
    }
  }
