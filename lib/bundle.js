...
class Game {
  ...
  incrementLevel() {
    ...
    this.board.clear();
    setTimeout(() => {
      this.board = new __WEBPACK_IMPORTED_MODULE_0__board__["a" /* default */](this.grid, this.level);
...
class Board {
  ...
  populate() {
    ...
    setTimeout(() => this.handleSet(__WEBPACK_IMPORTED_MODULE_1__jewel__["a" /* default */].retrieveMovedJewels()), 1200);
  }
  ...
  handleSelect(e) {
    ...
    console.log(this.getJewel(new __WEBPACK_IMPORTED_MODULE_3__pos__["a" /* default */](x, y)))
  ...
  handleSet(jewels) {
    ...
    setTimeout(() => { this.handleSet(__WEBPACK_IMPORTED_MODULE_1__jewel__["a" /* default */].retrieveMovedJewels()) }, 1000);
