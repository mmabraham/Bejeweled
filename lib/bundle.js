...
class Board {
  ...
  handleSet(jewels) {
    ...
    this.remove(toRemove).then(this.updateInCols.bind(this))//.then();
  ...
  //
  //   this.remove(toRemove).then(this.updateInCols.bind(this));
  //   return result;
  // }
    ...
    return new Promise(resolve => {
      setTimeout(() => {
        posRow.forEach((pos) => {
          ...
          this.cols[pos.x][0] = __WEBPACK_IMPORTED_MODULE_0__jewel__["a" /* default */].random(new __WEBPACK_IMPORTED_MODULE_2__pos__["a" /* default */](pos.x, 0), this.container).place()
        })
        resolve();
      }, 500)
    })
