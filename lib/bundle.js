...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__sounds__ = __webpack_require__(9);
...
class Jewel {
  ...
  remove(delay) {
    ...
    setTimeout(() => {
      __WEBPACK_IMPORTED_MODULE_0__sounds__["a" /* default */].match();
...
/* harmony export (immutable) */ __webpack_exports__["a"] = Jewel;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__timer__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__jewel__ = __webpack_require__(0);
...
class Game {
  constructor() {
    ...
    this.level = 5;
    this.timer = new __WEBPACK_IMPORTED_MODULE_1__timer__["a" /* default */]();
    this.modalContent.innerHTML = `Level ${this.level - 4}`
    this.board = new __WEBPACK_IMPORTED_MODULE_0__board__["a" /* default */](this, this.level);
    this.startLevel();
    this.pause();
  }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__progress__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__jewel__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__null_jewel__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pos__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__sounds__ = __webpack_require__(9);
...
class Board {
  constructor(game, level) {
    this.game = game;
    this.progress = new __WEBPACK_IMPORTED_MODULE_0__progress__["a" /* default */]();
  ...
  reset() {
    ...
    this.progress.reset(this.level * 70000)
    ...
    for (let x = 0; x < 8; x++) {
      this.cols[x] = {};
      for (let y = 0; y < 8; y++) {
        this.cols[x][y] = __WEBPACK_IMPORTED_MODULE_1__jewel__["a" /* default */].random(new __WEBPACK_IMPORTED_MODULE_3__pos__["a" /* default */](x, y), this.game.grid, this.level).place()
      }
    }
  }
  ...
  start() {
    this.frozen = false;
    this.handleMatch(__WEBPACK_IMPORTED_MODULE_1__jewel__["a" /* default */].getMovedJewels());
  }

  handleSelect(e) {
    if (e.target.id === "grid"  || this.frozen) return;
    const {x, y} = e.target.data
    this.selectJewel(new __WEBPACK_IMPORTED_MODULE_3__pos__["a" /* default */](x, y));
  }

  selectJewel(pos) {
    const newJewel = this.getJewel(pos);
    __WEBPACK_IMPORTED_MODULE_4__sounds__["a" /* default */].click();
  ...
  handleMatch(jewels) {
    ...
    setTimeout(() => {
      if (!this.frozen) this.handleMatch(__WEBPACK_IMPORTED_MODULE_1__jewel__["a" /* default */].getMovedJewels());
    }, 1000);
  ...
  handleSwap(jewel1, jewel2) {
    __WEBPACK_IMPORTED_MODULE_4__sounds__["a" /* default */].swap();
  ...
  replaceEmpty(positions) {
    positions.forEach((pos) => {
      ...
      this.cols[pos.x][0] = __WEBPACK_IMPORTED_MODULE_1__jewel__["a" /* default */].random(new __WEBPACK_IMPORTED_MODULE_3__pos__["a" /* default */](pos.x, 0), this.game.grid, this.level).place(700) // wait for swap and removal animation
    })
  }
  ...
  getJewel(pos) {
    return pos.isValid() ? this.cols[pos.x][pos.y] : new __WEBPACK_IMPORTED_MODULE_2__null_jewel__["a" /* default */](pos);
  }
  ...
  clear() {
    __WEBPACK_IMPORTED_MODULE_1__jewel__["a" /* default */].getMovedJewels(); // clear out last level's jewels
    setTimeout(() => {
      const allJewels = [];
      for (let y = 7; y >= 0; y--) {
        for (let x = 0; x < 8; x++) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__jewel__ = __webpack_require__(0);


class NullJewel extends __WEBPACK_IMPORTED_MODULE_0__jewel__["a" /* default */] {
  constructor(pos) {
    super(pos, null, 'NULL')
  }
...
/* harmony export (immutable) */ __webpack_exports__["a"] = NullJewel;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = Pos;
...
"use strict";
const Sounds = {
  click: () => {},//new Audio('./assets/audio/click.wav').play(),
  match: () => {},//new Audio('./assets/audio/match.wav').play(),
  swap: () => {},//new Audio('./assets/audio/switch.wav').play(),
}
