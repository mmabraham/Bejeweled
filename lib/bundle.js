...
class Game {
  constructor() {
    ...
    this.board = new __WEBPACK_IMPORTED_MODULE_0__board__["a" /* default */](this.grid, 5);
...
class Board {
  ...
  populate() {
    for (let x = 0; x < 8; x++) {
      this.cols[x] = {};
      for (let y = 0; y < 8; y++) {
        this.cols[x][y] = __WEBPACK_IMPORTED_MODULE_1__jewel__["a" /* default */].random(new __WEBPACK_IMPORTED_MODULE_3__pos__["a" /* default */](x, y), this.container, this.level).place()
      }
    }
  }
  ...
  updateInCols(posRow) {
    posRow.forEach((pos) => {
      ...
      this.cols[pos.x][0] = __WEBPACK_IMPORTED_MODULE_1__jewel__["a" /* default */].random(new __WEBPACK_IMPORTED_MODULE_3__pos__["a" /* default */](pos.x, 0), this.container, this.level).place(500)
    })
  }
