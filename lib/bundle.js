...
class Board {
  ...
  updateInCols(posRow) {
    posRow.forEach((pos) => {
      ...
      this.cols[pos.x][0] = __WEBPACK_IMPORTED_MODULE_1__jewel__["a" /* default */].random(new __WEBPACK_IMPORTED_MODULE_3__pos__["a" /* default */](pos.x, 0), this.game.grid, this.level).place(500)
    })
  }
