...
class Game {
  constructor() {
    ...
    this.board = new __WEBPACK_IMPORTED_MODULE_0__board__["a" /* default */](this.grid);
    this.board.populate();
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__null_jewel__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pos__ = __webpack_require__(5);
...
class Board {
  constructor(container) {
    ...
    // temporary
    // empty it out
    // setTimeout(() => Jewel.retrieveMovedJewels(), 3000);
  ...
  populate() {
    for (let x = 0; x < 8; x++) {
      this.cols[x] = {};
      for (let y = 0; y < 8; y++) {
        this.cols[x][y] = __WEBPACK_IMPORTED_MODULE_0__jewel__["a" /* default */].random(new __WEBPACK_IMPORTED_MODULE_2__pos__["a" /* default */](x, y), this.container).place()
      }
    }
  }
  ...
  handleSelect(e) {
    ...
    console.log(this.getJewel(new __WEBPACK_IMPORTED_MODULE_2__pos__["a" /* default */](x, y)))
    this.selectJewel(new __WEBPACK_IMPORTED_MODULE_2__pos__["a" /* default */](x, y));
  }
  ...
  handleSet(jewels) {
    ...
    this.remove(toRemove)
      ...
      .then(() => setTimeout(() => { this.handleSet(__WEBPACK_IMPORTED_MODULE_0__jewel__["a" /* default */].retrieveMovedJewels()) }, 1000));
  ...
  // animateBadSwitch(jewel1, jewel2) {
  //   jewel1.animateMove(jewel2.pos, 0);
  //   jewel2.animateMove(jewel1.pos, 0)
  //   jewel1.animateMove(jewel1.pos, 500);
  //   jewel2.animateMove(jewel2.pos, 500)
  // }
    ...
    return new Promise(resolve => {
        posRow.forEach((pos) => {
          for (let y = pos.y - 1; y >= 0; y--) {
            ...
            replacement.moveDown(500);
          }
          this.cols[pos.x][0] = __WEBPACK_IMPORTED_MODULE_0__jewel__["a" /* default */].random(new __WEBPACK_IMPORTED_MODULE_2__pos__["a" /* default */](pos.x, 0), this.container).place(500)
        })
  ...
  getJewel(pos) {
    return pos.isValid() ? this.cols[pos.x][pos.y] : new __WEBPACK_IMPORTED_MODULE_1__null_jewel__["a" /* default */](pos);
  }
